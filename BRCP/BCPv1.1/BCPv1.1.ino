...
//Red LED pins
const int outputRED1 = 16;
const int outputRED2 = 17;
const int outputRED4 = 18;
const int outputRED3 = 19;
//Green LED pins
const int outputGREEN1 = 20;
const int outputGREEN2 = 21;
const int outputGREEN3 = 22;
const int outputGREEN4 = 23;
//Motor pins
const int motor1pin1 = 24;
const int motor1pin2 = 25;

void Overrided(WiFiClient client){
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /closed/" ) >= 0) {
              ...
              delay(1);
              motorS();
            } else if(header.indexOf("GET /override/on/") >= 0){
              overrided = false;
              break;
            }
            ...
            if(overrided){
              client.println("<p><a href=\"/override/on/\"><button class=\"button button2\">Override ON</button></a></p>");
            }
...
void notOverrided(WiFiClient client){
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /closed/" ) >= 0) {
              ...
              delay(1);
              motorS();
            } else if(header.indexOf("GET /override/off/") >= 0){
              overrided = true;
              break;
            }
            ...
            if(!overrided){
              client.println("<p><a href=\"/override/off/\"><button class=\"button button2\">Override OFF</button></a></p>");
            }
            client.println("</body></html>");
